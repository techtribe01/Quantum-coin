...
import { ArrowRight, Code, Coins, LineChart, Lock, Rocket, Shield, ChevronDown, ChevronUp, Wallet, Flame, BarChart } from "lucide-react";
import { Logo, LogoIconType } from "@/components/layout/Logo";
import { useToast } from "@/hooks/use-toast";
import aiService, { QuantumCoinFeature } from "@/services/aiService";
...
export function ExploreProcess() {
  ...
  const processList = [
    {
      ...
      feature: "project" as QuantumCoinFeature
    },
    {
      ...
      feature: "mining" as QuantumCoinFeature
    },
    {
      ...
      feature: "stacking" as QuantumCoinFeature
    },
    {
      ...
      feature: "governance" as QuantumCoinFeature
    },
    {
      ...
      feature: "tokenomics" as QuantumCoinFeature
    },
    {
      ...
      feature: "defi" as QuantumCoinFeature
    }
  ];
  ...
  const generateAIDetails = async (feature: QuantumCoinFeature) => {
    setIsGenerating(true);
    
    try {
      const response = await aiService.generateQuantumCoinFunction(feature);
  ...
  const triggerGeneration = (e: React.MouseEvent, feature: QuantumCoinFeature) => {
    e.stopPropagation();
